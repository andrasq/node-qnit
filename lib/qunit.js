...
// FIXME: next test starts before previous test has called done(),
// which breaks tests that need to clean up between tests.  FIXME!
            }
        );
    }

    function reportit( tester, err, cb ) {
